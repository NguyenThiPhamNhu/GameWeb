...
<body>
	...
	<div class="container-fluid mt-3">
		...
		<form action="/admin/adminmanager" method="post" enctype="multipart/form-data">
			@csrf
			...
			<div class="form-row">
				<div class="form-group col-sm-6">
					...
					<input type="text" class="form-control"
					id="detail" name="detailNew" value="{{$data->detail}}">
				</div>
                <div class="form-group col-sm-6">
					<label for="comment">Comment</label>
					<input type="text" class="form-control"
					id="comment" name="commentNew" value="{{$data->comment}}">
				</div>

                <div class="form-group col-sm-6">
					<label for="evaluate">Evaluate</label>
					<input type="text" class="form-control"
					id="evaluate" name="evaluateNew" value="{{$data->evaluate}}">
				</div>
