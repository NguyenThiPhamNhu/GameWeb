...
class Posts extends Component {
    ...
    getData(id) {
        fetch("http://127.0.0.1:8000/api/posts/" + 2)
            .then(response => {
                    ...
                    {this.state.post.map((item) =>
                        <div className="show">
                            ...
                            <div class="thumbnail">
                                ...
                                <hr />
                                <div className="Menu">
                                    {/* <p className="menulink"><li><Link to="/gioithieu">GIỚI THIỆU</Link></li></p> */}
                                    <p><img
                                        src={"http://127.0.0.1:8000/storage/" + item.image}
                                        alt=""
                                        width={400}
                                        height={400}
                                    /><Link className="link" to="/gioithieu">GIỚI THIỆU</Link>
                                    </p>
                                    <hr />
                                    <p><img
                                        src={"http://127.0.0.1:8000/storage/" + item.image}
                                        ...
                                        width={400}
                                        height={400}
                                    /><Link className="link" to="/p">GIỚI THIỆU</Link>
                                    </p>
                                    <hr />
                                    <p><img
                                        src={"http://127.0.0.1:8000/storage/" + item.image}
